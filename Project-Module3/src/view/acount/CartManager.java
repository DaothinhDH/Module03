...
public class CartManager {
    ...
    public void menuCart() {
        ...
        if (cartService != null && productService != null) {
            ...
            System.out.println("║     "+WHITE_BOLD_BRIGHT+"1. Tăng số lượng sản phẩm"+LIGHT_CYAN+"      ║    "+WHITE_BOLD_BRIGHT+"2. Giảm số lượng sản phẩm"+LIGHT_CYAN+"    ║ ");
            System.out.println("║══════════════════════════════════════════════════════════════════════║");
            System.out.println("║     "+WHITE_BOLD_BRIGHT+"3. Xóa sản phẩm"+LIGHT_CYAN+"                ║    "+WHITE_BOLD_BRIGHT+"4. Thanh toán"+LIGHT_CYAN+"                ║");
            ...
            switch (choice) {
                case 1:
                    System.out.println("Chưc năng này chưa cập nhật");
                    break;
                case 2:
                    System.out.println("Chưc năng này chưa cập nhật");
                    break;
